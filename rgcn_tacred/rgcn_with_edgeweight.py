...
def func(re):
    ...
    k = 1
    model = Model(43, 20, 5, hetero_graph.etypes)
...
rel_types = ['child', 'childrens', 'colleague', 'employee_of', 'employees', 'founded_by', 'friend', 'member_of', 'members', 'no_relation', 'nothing', 'other_family', 'parent', 'parents', 'partner', 'relation', 'relations', 'rival', 'shareholders', 'siblings', 'spouse', 'subsidiaries']
for re in rel_types:
    sum = 0
    for i in range(10):
        sum = sum + func(re)
