...
k = 5
model = Model(114, 9760, 1, hetero_graph.etypes)
...
for epoch in range(10):
    negative_graph = construct_negative_graph(hetero_graph, k, ('Person', 'no_relation', 'Person'))
    print(negative_graph)
    pos_score = model(hetero_graph, negative_graph, node_features, ('Person', 'relation', 'Person'))
    print(pos_score)
